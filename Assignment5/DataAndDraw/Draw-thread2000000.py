...
with open('result2000000-1.csv','r') as csvfile:
...
with open('result2000000-2.csv','r') as csvfile:
    lines = csv.reader(csvfile, delimiter=',')
    for row in lines:
        x.append(float(row[0])*2000000)
        y.append(float(row[1]))
...
with open('result2000000-4.csv','r') as csvfile:
    lines = csv.reader(csvfile, delimiter=',')
    for row in lines:
        x.append(float(row[0])*2000000)
        y.append(float(row[1]))
...
plt.title('2E6 Array Length Runtime Report', fontsize = 20)
plt.grid()
plt.legend()
plt.show()